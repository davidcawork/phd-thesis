...
\input{include/config_init}
\input{include/vars.tex}
...
% Portada
\input{include/cover/front.tex}

\clearemptydoublepage

% Cover
\input{include/cover/cover.tex}
...
% Init
\input{body/00_Preliminary/00_preliminaresconagradecimientos.tex}
...
% Body
\input{body/01_Intro/intro.tex}
\input{body/02_Sota/sota.tex}
\input{body/03_Problema/problem.tex}
\input{body/04_in-band/inband.tex}
\input{body/05_den2ne/den2ne.tex}
\input{body/06_fault_sg/fault_sg}
\input{body/07_bloste/bloste}
\input{body/08_datadriven/datadriven}
\input{body/09_conclu/conclusiones}
%\input{body/01_Intro/test.tex}

% Anexos 
\appendix
\input{body/10_anexos/repos}
